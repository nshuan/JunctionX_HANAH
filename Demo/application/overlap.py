...
def getPoints(image1, image2, point_map, inliers=None, max_points=500):
...
def overlap(imgs, downscale=1):
    ...
    finish = clock()
    return ret_img, (finish - start)/(1e9)
